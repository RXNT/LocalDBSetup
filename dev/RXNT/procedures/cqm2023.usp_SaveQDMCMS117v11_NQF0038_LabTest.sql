...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SaveQDMCMS117v11_NQF0038_LabTest]
	@RequestId BIGINT
AS
BEGIN
	...
	[cqm2023].[FindClosestEncounter](lrf.obs_date, lm.pat_id, @DoctorId) AS EncounterId,
	...
	INNER JOIN [cqm2023].[SysLookupCMS117v11_NQF0038] cqm WITH(NOLOCK) ON lrf.obs_bat_ident = cqm.code 
