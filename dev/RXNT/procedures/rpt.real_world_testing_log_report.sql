...
SET ANSI_NULLS ON 
GO
CREATE   PROCEDURE [rpt].[real_world_testing_log_report] --EXEC [rpt].[real_world_testing_log_report] '2022-12-20';
  @today DateTime
AS
BEGIN	
	DECLARE @body NVARCHAR(MAX)
	--DECLARE @today DateTime = GETDATE()
	DECLARE @thirtyDaysAgo DateTime = DATEADD(dd,-30, GETDATE())
