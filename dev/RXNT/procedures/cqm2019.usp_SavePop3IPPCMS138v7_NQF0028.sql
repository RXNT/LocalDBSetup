...
-- =============================================
CREATE PROCEDURE [cqm2019].[usp_SavePop3IPPCMS138v7_NQF0028]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO cqm2019.DoctorCQMCalcPop3CMS138v7_NQF0028
	...
	LEFT JOIN [cqm2019].[DoctorCQMCalcPop3CMS138v7_NQF0028] IPP WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
