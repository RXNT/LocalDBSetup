...
SET ANSI_NULLS ON 
GO
--[phr].[usp_GetCompanyApplicationConfiguration]  25684, 'PHR'

CREATE PROCEDURE [phr].[usp_GetCompanyApplicationConfiguration]  
(
	@DoctorCompanyId		BIGINT,
	@ApplicationName	VARCHAR(5)
)
AS
BEGIN
	SET NOCOUNT ON;
	...
	WHERE AC.Active = 1  AND AC.ApplicationName=@ApplicationName
