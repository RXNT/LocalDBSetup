...
-- Description: Procedure to get the measures data for Demographics    
-- =============================================    
CREATE PROCEDURE [dbo].[StageII_Measures_Get_Demographics]    
...
BEGIN    
 ...
 (    
  select  'DMG' as MeasureCode, 'MU2014' as MeasureStage, @dr_id as dr_id    
 ),    
 ...
 Numerator_Data as    
 (    
  select  sum(case when pat.pref_lang > 0 and pat.pa_race_type > 0 and pat.pa_sex is not null and  pat.pa_dob is not null    
      then 1 else 0 end ) as Numerator, pen.dr_id    
