...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SavePop1IPPCMS138v11_NQF0028]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO cqm2023.DoctorCQMCalcPop1CMS138v11_NQF0028
	...
	INNER JOIN cqm2023.PatientEncounterCodes pec ON pec.PatientId=pat.pa_id
	LEFT JOIN [cqm2023].[DoctorCQMCalcPop1CMS138v11_NQF0028] IPP ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
