...
-- Description:	To populate QDM tables for the measure CMS68v11_NQF0419_Procedure
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SaveQDMCMS68v11_NQF0419_Procedures]
	@RequestId BIGINT
AS
BEGIN
	...
	LEFT JOIN cqm2022.PatientProcedureCodes pec WITH(NOLOCK) ON pat.pa_id=pec.PatientId AND pec.Code = proce.code AND pec.PerformedFromDate = proce.date_performed
