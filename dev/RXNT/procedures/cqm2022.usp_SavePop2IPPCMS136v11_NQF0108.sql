...
CREATE   PROCEDURE [cqm2022].[usp_SavePop2IPPCMS136v11_NQF0108]
	@RequestId BIGINT  
AS
BEGIN
	...
	(
		...
		LEFT JOIN cqm2022.DoctorCQMCalcPop1CMS136v11_NQF0108 IPP WITH(NOLOCK) on IPP.PatientId = pmc.PatientId AND IPP.RequestId = @RequestId
	...
	INSERT INTO cqm2022.DoctorCQMCalcPop2CMS136v11_NQF0108
	...
	INNER JOIN cqm2022.PatientMedicationCodes pmc  WITH(NOLOCK) ON pmc.EncounterId= pec.EncounterId and pmc.PatientId=pec.PatientId and pmc.MedicationId is not null	
	INNER JOIN InitialADHDMedication M ON M.pa_id=pec.PatientId			
	--LEFT JOIN cqm2022.DoctorCQMCalcPop1CMS136v11_NQF0108 IPP  WITH(NOLOCK) on IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
