...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SavePop3IPPCMS155v11_NQF0024]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO [cqm2022].[DoctorCQMCalcPop3CMS155v11_NQF0024]
	...
	LEFT JOIN [cqm2022].[DoctorCQMCalcPop3CMS155v11_NQF0024] IPP WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
