...
-- =============================================
CREATE PROCEDURE [cqm2019].[usp_SavePop1IPPCMS138v7_NQF0028]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO cqm2019.DoctorCQMCalcPop1CMS138v7_NQF0028
	...
	INNER JOIN cqm2019.PatientEncounterCodes pec ON pec.PatientId=pat.pa_id
	LEFT JOIN [cqm2019].[DoctorCQMCalcPop1CMS138v7_NQF0028] IPP ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
