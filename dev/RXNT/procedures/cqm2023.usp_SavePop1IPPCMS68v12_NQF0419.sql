...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SavePop1IPPCMS68v12_NQF0419]
	@RequestId BIGINT  
AS
BEGIN
	...
	LEFT JOIN cqm2023.DoctorCQMCalcPop1CMS68v12_NQF0419 IPP WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId AND CAST(pec.PerformedFromDate AS DATE)=CAST(IPP.DatePerformed AS DATE)
