...
Description			:	Save Patient SocialHx From Patient Encounter
=======================================================================================
*/
CREATE PROCEDURE [enc].[usp_SavePatientSocialHxFromPatientEncounter]
...
BEGIN
	...
	BEGIN
        ...
        ,EmotionallyAbusedStatusId,AfraidStatusId,SexualHarrasmentStatusId,KHSHurtStatusId)
		 VALUES
		...
		@ChurchAttendCount,@ChurchAttendCountND,@ClubOrgMemberStatusId,@EmotionallyAbusedStatusId,@AfraidStatusId,@SexualHarrasmentStatusId,@KHSHurtStatusId)
