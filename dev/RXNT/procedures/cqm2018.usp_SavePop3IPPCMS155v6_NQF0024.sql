...
-- =============================================
CREATE PROCEDURE [cqm2018].[usp_SavePop3IPPCMS155v6_NQF0024]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO [cqm2018].[DoctorCQMCalcPop3CMS155v6_NQF0024]
	...
	LEFT JOIN [cqm2018].[DoctorCQMCalcPop3CMS155v6_NQF0024] IPP WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
	WHERE  IPP.CalcId IS NULL AND pec.DoctorId = @DoctorId AND
