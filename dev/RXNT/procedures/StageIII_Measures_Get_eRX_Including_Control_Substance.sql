...
-- Description: Procedure to get the measures data for eRX including control substance.  
-- =============================================  
CREATE PROCEDURE [dbo].[StageIII_Measures_Get_eRX_Including_Control_Substance]  
	@dr_id INT, 
	@dg_id INT=NULL, 
