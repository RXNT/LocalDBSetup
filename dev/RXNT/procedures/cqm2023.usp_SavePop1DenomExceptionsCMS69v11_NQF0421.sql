...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SavePop1DenomExceptionsCMS69v11_NQF0421]
	@RequestId BIGINT  
AS
BEGIN
	...
	INNER JOIN cqm2023.PatientEncounterCodes enc  WITH(NOLOCK) ON enc.EncounterId=ppc.EncounterId 
