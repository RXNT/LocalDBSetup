...
-- Description:	To search Patient Encounters study for Measure CMS68v11_NQF0419
-- =============================================

CREATE   PROCEDURE [cqm2022].[usp_SearchPatientIntervention_CMS68v11_NQF0419] 
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	 ...
	 BEGIN
		...
		FROM cqm2022.PatientInterventionCodes pec WITH(NOLOCK)
		...
		INNER JOIN cqm2022.SysLookupCQMValueSet vs WITH(NOLOCK) ON codes.ValueSetId = vs.ValueSetId AND vs.QDMCategoryId= 9 --Intervention
