...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SaveQDMCMS68v12_NQF0419_Encounter]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN cqm2022.SysLookupCMS68v12_NQF0419 cqm  WITH(NOLOCK) ON cqm.Code = proce.code AND proce.type='Encounter'
