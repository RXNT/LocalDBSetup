...
-- =============================================
-- Author:		Rasheed
-- Create date: 29-DESC-2022
-- Description:	To save the Doctor cqm2022 Request
-- =============================================
CREATE   PROCEDURE [cqm2022].[SaveDoctorCQMRequest]  
...
BEGIN
	...
	IF NOT EXISTS(
		SELECT *  FROM cqm2022.DoctorCQMCalculationRequest  WITH(NOLOCK)
	...
	BEGIN
		INSERT INTO cqm2022.DoctorCQMCalculationRequest
