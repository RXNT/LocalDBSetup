...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SaveQDMCMS147v12_NQF0041_Immunization]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN cqm2022.SysLookupCMS147v12_NQF0041 cqm WITH(NOLOCK) ON cqm.Code = vacc.CVX_CODE
