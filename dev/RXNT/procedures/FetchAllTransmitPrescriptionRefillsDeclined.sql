...
-- Description: Fetch all transmit prescription Refills Declined
-- Modified By : 
-- Modified Date: 
-- Modified Description: 
-- =============================================  
CREATE  PROCEDURE [dbo].[FetchAllTransmitPrescriptionRefillsDeclined]
 @Participant int,  
 @MaxRetryCount INT=0,
 @version VARCHAR(50)
AS  
  ...
  BEGIN
	...
	SET NOCOUNT ON;
	 SELECT DISTINCT TOP 50 pvt_id,A.delivery_method,A.pd_id,A.pres_id, 0 transmission_flags,B.pres_prescription_type,B.presc_src,DR_STATE, 
