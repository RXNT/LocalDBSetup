...
CREATE   PROCEDURE [cqm2023].[usp_GetDoctorQRDAIII_CMS155v11_NQF0024_POP2]  
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
AS
BEGIN
	 ...
	 BEGIN
		 ...
		 FROM  [cqm2023].[DoctorCQMCalcPop2CMS155v11_NQF0024] N WITH(NOLOCK)
		...
		INNER JOIN [cqm2023].[DoctorCQMCalcPop2CMS155v11_NQF0024] N WITH(NOLOCK) ON pat.pa_id = N.PatientId
		...
		INNER JOIN [cqm2023].[DoctorCQMCalcPop2CMS155v11_NQF0024] N WITH(NOLOCK) ON pyr.pa_id = N.PatientId
