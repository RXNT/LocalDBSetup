...
CREATE    PROCEDURE [cqm2023].[usp_SearchPatientActiveMedication_CMS68v12_NQF0419]  
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	...
	PAM_ID, A.DRUG_ID, R.MED_REF_DEA_CD drug_class,
		...
		SELECT pam_id AS ActiveMedId, pd.pd_id AS PrescriptionDetailId, pd.duration_amount As DurationAmount, pd.duration_unit AS DurationUnit FROM cqm2023.PatientMedicationCodes pec WITH(NOLOCK)
		INNER JOIN PATIENT_ACTIVE_MEDS A WITH(NOLOCK) ON pec.MedicationId=A.pam_id
