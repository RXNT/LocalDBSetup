...
-- =============================================
CREATE   PROCEDURE [cqm2022].[SavePop1DenomExceptionsCMS147v12_NQF0041]  
	@RequestId BIGINT  
AS
BEGIN
	SET NOCOUNT ON;
	...
	INNER JOIN cqm2022.SysLookUpCMS147v12_NQF0041 cqm WITH(NOLOCK) on cqm.code = pdc.code
	...
	INNER JOIN cqm2022.[SysLookUpCMS147v12_NQF0041] cqm WITH(NOLOCK) on cqm.code = pmc.code
	WHERE dg.dc_id=@DoctorCompanyId AND IPP.DoctorId = @DoctorId
