...
-- =============================================
CREATE   PROCEDURE [ehr].[usp_SavePatientMedicalHx]
	@ID BIGINT OUTPUT,
	@PatientId BIGINT,
	@Problem VARCHAR(MAX),
	@ICD10 VARCHAR(MAX),
...
BEGIN
	IF ISNULL(@ID,0) = 0
	BEGIN
		INSERT INTO patient_medical_hx (pat_id,problem,dr_id,added_by_dr_id,created_on,last_modified_on,last_modified_by,enable,
	...
	BEGIN
		...
		WHERE pat_id=@PatientId AND medhxid=@ID;
	END
END
