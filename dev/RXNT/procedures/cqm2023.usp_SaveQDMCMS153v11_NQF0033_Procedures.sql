...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SaveQDMCMS153v11_NQF0033_Procedures]
	@RequestId BIGINT
AS
BEGIN
	...
	SELECT pp.pa_id, [cqm2023].[FindClosestEncounter](pp.date_performed, pp.pa_id, @DoctorId) AS EncounterId,
	...
	INNER JOIN cqm2023.[SysLookupCMS153v11_NQF0033] cqm WITH(NOLOCK) on cqm.code = pp.code
