...
CREATE   PROCEDURE [cqm2022].[usp_SearchPatientNotDoneProcedures_CMS68v12_NQF0419]  
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	 ...
	 BEGIN
		...
		INNER JOIN cqm2022.SysLookupCMS68v12_NQF0419 codes ON pp.reason_type_code = codes.Code
