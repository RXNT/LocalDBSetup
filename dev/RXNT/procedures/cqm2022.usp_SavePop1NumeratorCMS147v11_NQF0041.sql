...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SavePop1NumeratorCMS147v11_NQF0041]
	@RequestId BIGINT 
AS
BEGIN
	...
	UPDATE TOP(@MaxRowCount) cqm2022.DoctorCQMCalcPOP1CMS147v11_NQF0041
	SET Numerator = 1 
	FROM [cqm2022].[DoctorCQMCalcPOP1CMS147v11_NQF0041] pat WITH(NOLOCK)
	...
	INNER JOIN cqm2022.[SysLookupCMS147v11_NQF0041] cqm WITH(NOLOCK) on cqm.Code = ppc_s.Code
	...
	INNER JOIN [cqm2022].[SysLookupCMS147v11_NQF0041] cqm WITH(NOLOCK) ON pmc.Code = cqm.code
