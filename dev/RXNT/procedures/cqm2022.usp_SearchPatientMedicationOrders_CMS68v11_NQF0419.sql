...
CREATE   PROCEDURE [cqm2022].[usp_SearchPatientMedicationOrders_CMS68v11_NQF0419]
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	 ...
	 BEGIN
		...
		LEFT OUTER  JOIN cqm2022.SysLookupCMS68v11_NQF0419 codes_rson ON pp_rson.code = codes_rson.Code
		LEFT OUTER  JOIN cqm2022.SysLookupCodeSystem cs_rson ON codes_rson.CodeSystemId = cs_rson.CodeSystemId
		LEFT OUTER  JOIN cqm2022.SysLookupCQMValueSet vs_rson ON codes_rson.ValueSetId = vs_rson.ValueSetId
