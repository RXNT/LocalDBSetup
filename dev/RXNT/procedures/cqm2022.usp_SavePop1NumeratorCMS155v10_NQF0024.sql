...
CREATE   PROCEDURE [cqm2022].[usp_SavePop1NumeratorCMS155v10_NQF0024]  
@RequestId BIGINT  
AS
BEGIN
...
IF OBJECT_ID('tempdb..#usp_SavePop1NumeratorCMS155v10_NQF0024') IS NOT NULL DROP TABLE #usp_SavePop1NumeratorCMS155v10_NQF0024
SELECT TOP(@MaxRowCount) IPP.CalcId
INTO #usp_SavePop1NumeratorCMS155v10_NQF0024
FROM cqm2022.[DoctorCQMCalcPop1CMS155v10_NQF0024] IPP WITH(NOLOCK)
...
INNER JOIN [cqm2022].[SysLookUpCMS155v10_NQF0024] cqm1 WITH(NOLOCK) ON cqm1.Code = bmi.Code
INNER JOIN cqm2022.PatientPhysicalExamCodes height WITH(NOLOCK) ON height.PatientId = IPP.PatientId
INNER JOIN [cqm2022].[SysLookUpCMS155v10_NQF0024] cqm2 WITH(NOLOCK) ON cqm2.Code = height.Code
INNER JOIN cqm2022.PatientPhysicalExamCodes weight WITH(NOLOCK) ON weight.PatientId = IPP.PatientId
INNER JOIN [cqm2022].[SysLookUpCMS155v10_NQF0024] cqm3 WITH(NOLOCK) ON cqm3.Code = weight.Code
...
SET Numerator = 1
FROM cqm2022.[DoctorCQMCalcPop1CMS155v10_NQF0024] IPP WITH(NOLOCK)
INNER JOIN #usp_SavePop1NumeratorCMS155v10_NQF0024 IPP_Temp WITH(NOLOCK) ON IPP.CalcId=IPP_Temp.CalcId
...
SELECT @AffectedRows;
DROP TABLE #usp_SavePop1NumeratorCMS155v10_NQF0024
