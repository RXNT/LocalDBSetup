...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SaveQDMCMS68v12_NQF0419_Medications]
	@RequestId BIGINT
AS
BEGIN
	...
	LEFT JOIN cqm2023.[SysLookupCMS68v12_NQF0419] cqm WITH(NOLOCK) ON cqm.code = '428191000124101'
