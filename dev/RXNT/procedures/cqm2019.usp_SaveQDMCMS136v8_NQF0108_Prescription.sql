...
-- =============================================
CREATE PROCEDURE [cqm2019].[usp_SaveQDMCMS136v8_NQF0108_Prescription]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN [cqm2019].[SysLookupCMS136v8_NQF0108] cqm WITH(NOLOCK) ON cqm.Code = r1.EVD_EXT_VOCAB_ID
