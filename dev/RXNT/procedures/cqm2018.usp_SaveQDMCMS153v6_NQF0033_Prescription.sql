...
-- =============================================
CREATE PROCEDURE [cqm2018].[usp_SaveQDMCMS153v6_NQF0033_Prescription]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN cqm2018.[SysLookupCMS153v6_NQF0033] cqm WITH(NOLOCK) on cqm.code = vwRx.RxNormCode
	...
	AND cqm.QDMCategoryId = 5 AND cqm.CodeSystemId = 10 AND cqm.ValueSetId IN (73,81)
