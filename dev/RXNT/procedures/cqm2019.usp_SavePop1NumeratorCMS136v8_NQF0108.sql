...
CREATE PROCEDURE [cqm2019].[usp_SavePop1NumeratorCMS136v8_NQF0108]
	@RequestId BIGINT  
AS
BEGIN
	...
	UPDATE TOP(@MaxRowCount) cqm2019.DoctorCQMCalcPOP1CMS136v8_NQF0108
	SET Numerator = 1
	FROM cqm2019.DoctorCQMCalcPOP1CMS136v8_NQF0108 IPP WITH(NOLOCK)
	INNER JOIN patients pat WITH(NOLOCK) ON pat.pa_id=IPP.PatientId
	INNER JOIN doc_groups dg WITH(NOLOCK) ON pat.dg_id=dg.dg_id
