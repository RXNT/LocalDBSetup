...
CREATE PROCEDURE [cqm2019].[usp_SaveQDMCMS69v7_NQF0421_PhysicalExam]
	@RequestId BIGINT
AS
BEGIN
	...
	SELECT pv.pa_id, [cqm2019].[FindClosestEncounter](pv.record_date, pv.pa_id, @DoctorId) AS EncounterId,
	...
	LEFT JOIN cqm2019.PatientPhysicalExamCodes phec WITH(NOLOCK) ON phec.PatientId = pv.pa_id AND phec.PhysicalExamId = pv.pa_vt_id AND phec.Code = '39156-5'
