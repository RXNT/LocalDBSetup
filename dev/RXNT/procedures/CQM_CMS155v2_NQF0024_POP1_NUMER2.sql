...
-- =============================================
CREATE PROCEDURE [dbo].[CQM_CMS155v2_NQF0024_POP1_NUMER2] 
...
BEGIN
	...
	BEGIN
		 SELECT COUNT(DISTINCT pat.pa_id)SM from patients PAT inner join (select pp.pa_id from patient_procedures PP
          ...
          AND cqm_num.version=2 AND cqm_num.NQF_id='0024'AND cqm_num.criteriatype='NUM2'  and cqm_num.code_type IN ('CPT','SNOMEDCT')  and cqm_num.IsActive=1 and cqm_num.IsExclude=0
