...
CREATE    PROCEDURE [cqm2023].[usp_GetDoctorQRDAIII_CMS138v11_NQF0028_POP1]
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
AS
BEGIN
	 ...
	 BEGIN
		 ...
		 FROM  [cqm2023].[DoctorCQMCalcPop1CMS138v11_NQF0028] N WITH(NOLOCK)
		...
		INNER JOIN [cqm2023].[DoctorCQMCalcPop1CMS138v11_NQF0028] N WITH(NOLOCK) ON pat.pa_id = N.PatientId
		...
		INNER JOIN [cqm2023].[DoctorCQMCalcPop1CMS138v11_NQF0028] N WITH(NOLOCK) ON pyr.pa_id = N.PatientId
