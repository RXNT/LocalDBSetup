...
CREATE   PROCEDURE [cqm2022].[usp_SavePop3NumeratorCMS155v11_NQF0024]
	@RequestId BIGINT  
AS
BEGIN
	...
	SET Numerator = 1
	FROM cqm2022.[DoctorCQMCalcPop3CMS155v11_NQF0024] IPP WITH(NOLOCK)
	...
	INNER JOIN [cqm2022].[SysLookUpCMS155v11_NQF0024] cqm WITH(NOLOCK) on cqm.code = ppc.code
