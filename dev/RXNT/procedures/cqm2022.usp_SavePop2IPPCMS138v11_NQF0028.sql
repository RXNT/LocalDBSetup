...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SavePop2IPPCMS138v11_NQF0028]
	@RequestId BIGINT  
AS
BEGIN
	...
	INNER JOIN cqm2022.PatientEncounterCodes pec WITH(NOLOCK) ON pec.PatientId=pat.pa_id
	...
	INSERT INTO cqm2022.DoctorCQMCalcPop2CMS138v11_NQF0028
	...
	LEFT JOIN [cqm2022].[DoctorCQMCalcPop2CMS138v11_NQF0028] IPP WITH(NOLOCK) ON IPP.PatientId = T1.pa_id AND IPP.RequestId = @RequestId
