...
-- =============================================
CREATE PROCEDURE [cqm2019].[usp_SaveQDMCMS153v7_NQF0033_DiagnosticStudy]
	@RequestId BIGINT
AS
BEGIN
	...
	--Diagnostic Study
	INSERT INTO cqm2019.PatientDiagnosticStudyCodes	
	(DiagnosticStudyId, EncounterId, PatientId, DoctorId, CodeSystemId, Code, PerformedFromDate)	
	SELECT lrf.lab_result_info_id, 
	[cqm2019].[FindClosestEncounter](CASE WHEN lrf.obs_date LIKE '1901-01-01' THEN lm.message_date ELSE lrf.obs_date END, lm.pat_id, @DoctorId) AS EncounterId,
	...
	INNER JOIN cqm2019.SysLookupCMS153v7_NQF0033 cqm WITH(NOLOCK) ON lrf.obs_bat_ident = cqm.code 
	LEFT JOIN cqm2019.PatientDiagnosticStudyCodes pltc WITH(NOLOCK) on lrf.lab_result_info_id = pltc.DiagnosticStudyId AND pltc.EncounterId = EncounterId 
	...
	AND cqm.QDMCategoryId = 15 AND cqm.CodeSystemId =13
