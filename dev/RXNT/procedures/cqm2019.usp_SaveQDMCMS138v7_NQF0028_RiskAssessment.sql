...
-- =============================================
CREATE PROCEDURE [cqm2019].[usp_SaveQDMCMS138v7_NQF0028_RiskAssessment]
	@RequestId BIGINT
AS
BEGIN
	...
	INSERT INTO [cqm2019].[PatientRiskCategoryOrAssessmentCodes]
	...
	LEFT JOIN cqm2019.PatientRiskCategoryOrAssessmentCodes prc WITH(NOLOCK) ON prc.PatientID = pec.PatientId AND prc.RiskCategoryOrAssessmentId = pfd.pa_flag_id AND prc.DoctorId = pec.DoctorId
