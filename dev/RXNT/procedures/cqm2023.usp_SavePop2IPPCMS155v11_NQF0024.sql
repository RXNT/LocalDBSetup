...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SavePop2IPPCMS155v11_NQF0024]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO [cqm2023].[DoctorCQMCalcPop2CMS155v11_NQF0024]
	...
	LEFT JOIN cqm2023.[DoctorCQMCalcPop2CMS155v11_NQF0024] IPP WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
