...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SavePop1IPPCMS69v10_NQF0421]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO [cqm2022].[DoctorCQMCalcPop1CMS69v10_NQF0421]
	...
	LEFT JOIN cqm2022.[DoctorCQMCalcPop1CMS69v10_NQF0421] IPP  WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
