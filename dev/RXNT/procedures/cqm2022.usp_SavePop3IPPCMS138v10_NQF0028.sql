...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SavePop3IPPCMS138v10_NQF0028]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO cqm2022.DoctorCQMCalcPop3CMS138v10_NQF0028
	...
	LEFT JOIN [cqm2022].[DoctorCQMCalcPop3CMS138v10_NQF0028] IPP WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
