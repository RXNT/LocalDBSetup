...
-- Modified Date: 
-- =============================================
CREATE PROCEDURE [enc].[usp_GetPatientDiagnosis]
	@PatientId BIGINT
AS
...
BEGIN
	...
	pad.date_added,pad.enabled, pad.onset, pad.severity, pad.record_source, pad.status_date, pad.diagnosis_sequence
