...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SaveQDMCMS153v11_NQF0033_DiagnosticStudy]
	@RequestId BIGINT
AS
BEGIN
	...
	--Diagnostic Study
	INSERT INTO cqm2023.PatientDiagnosticStudyCodes	
	(DiagnosticStudyId, EncounterId, PatientId, DoctorId, CodeSystemId, Code, PerformedFromDate)	
	SELECT lrf.lab_result_info_id, 
	[cqm2023].[FindClosestEncounter](CASE WHEN lrf.obs_date LIKE '1901-01-01' THEN lm.message_date ELSE lrf.obs_date END, lm.pat_id, @DoctorId) AS EncounterId,
	...
	INNER JOIN cqm2023.SysLookupCMS153v11_NQF0033 cqm WITH(NOLOCK) ON lrf.obs_bat_ident = cqm.code 
	LEFT JOIN cqm2023.PatientDiagnosticStudyCodes pltc WITH(NOLOCK) on lrf.lab_result_info_id = pltc.DiagnosticStudyId AND pltc.EncounterId = EncounterId 
