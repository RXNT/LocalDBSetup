...
CREATE PROCEDURE [cqm2018].[usp_GetDoctorQRDAIII_CMS155v6_NQF0024_POP1]
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
AS
BEGIN
	 ...
	 BEGIN
		...
		INNER JOIN [cqm2018].[DoctorCQMCalcPop1CMS155v6_NQF0024] N WITH(NOLOCK) ON pat.pa_id = N.PatientId
		...
		INNER JOIN [cqm2018].[DoctorCQMCalcPop1CMS155v6_NQF0024] N WITH(NOLOCK) ON pyr.pa_id = N.PatientId
