...
-- Description:	To save the numerator for the measure CMS153v7_NQF0033
-- =============================================

CREATE PROCEDURE [cqm2019].[usp_SavePop1NumeratorCMS153v7_NQF0033]
	@RequestId BIGINT  
AS
BEGIN
	...
	AND cqm.QDMCategoryId = 9 AND cqm.CodeSystemId = 13 AND cqm.ValueSetId = 71
