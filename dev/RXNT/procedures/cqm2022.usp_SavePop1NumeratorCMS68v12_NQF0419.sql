...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SavePop1NumeratorCMS68v12_NQF0419]
	@RequestId BIGINT 
AS
BEGIN
	...
	FROM  cqm2022.[DoctorCQMCalcPop1CMS68v12_NQF0419] calc WITH(NOLOCK)
	...
	LEFT JOIN cqm2022.DoctorCQMCalcPop1CMS68v12_NQF0419 IPP WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId AND CAST(ppc.PerformedFromDate AS DATE)=CAST(IPP.DatePerformed AS DATE) AND IPP.Numerator =1
