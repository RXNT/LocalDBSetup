...
CREATE PROCEDURE [ehr].[usp_SavePatientMichiganReferral]
...
BEGIN
   ...
   [inst_id],[referral_version])
   VALUES(@MAINDRID, @TARGETDRID, @PatientId, @ref_det_id,@ReferralDate, @ReferralEndDate, 
   @CarrierId, @MemberId, @REFDETIDENT, @MAINDRID1, @MAINDRID2, @TARDRID1, @TARDRID2,@INSTID,@ReferralVersion); 
