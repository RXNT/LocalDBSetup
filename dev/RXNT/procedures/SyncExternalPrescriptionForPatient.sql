...
-- =============================================
CREATE PROCEDURE [dbo].[SyncExternalPrescriptionForPatient] 
	(@PatientId AS VARCHAR(200))
AS
BEGIN
	SELECT P.PRES_ID, P.PRES_ENTRY_DATE, P.PRES_APPROVED_DATE, P.PRES_VOID,P.ELIGIBILITY_CHECKED, 
	P.ELIGIBILITY_TRANS_ID, P.PRINT_OPTIONS, 
	P.PRES_VOID_CODE, P.IS_SIGNED,P.PRES_PRESCRIPTION_TYPE, P.PRES_DELIVERY_METHOD, P.PRES_VOID_COMMENTS, 
	P.ADMIN_NOTES,P.PHARM_ID, P.PA_ID, 
	P.DR_ID, P.PRIM_DR_ID, P.AUTHORIZING_DR_ID, P.PRES_START_DATE, P.PRES_END_DATE,PD.PD_ID, PD.DDID, 
	PD.DRUG_NAME, PD.DOSAGE, PD.USE_GENERIC, PD.NUMB_REFILLS, 
	CASE WHEN PD.REFILLS_PRN IS NULL THEN 0 ELSE PD.REFILLS_PRN END REFILLS_PRN,PD.DURATION_AMOUNT, 
	PD.DURATION_UNIT, PD.COMMENTS, PD.PRN,
	PD.INCLUDE_IN_PRINT, PD.DAYS_SUPPLY, PD.INCLUDE_IN_PHARM_DELIVER, PD.SCRIPT_GUIDE_STATUS, 
	PD.SCRIPT_GUIDE_ID, PD.AS_DIRECTED, PD.ICD9,  PD.PRN_DESCRIPTION, 
