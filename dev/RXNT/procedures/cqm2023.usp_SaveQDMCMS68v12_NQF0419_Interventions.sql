...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SaveQDMCMS68v12_NQF0419_Interventions]
	@RequestId BIGINT
AS
BEGIN
	...
	LEFT JOIN cqm2023.[PatientInterventionCodes] pec WITH(NOLOCK) ON  pec.Code = proce.code AND pec.PerformedFromDate = proce.date_performed
