...
=======================================================================================
*/
CREATE PROCEDURE [ehr].[usp_GetPatientPastHxMedication] --24870502,2824
	@PatientId			BIGINT,
...
BEGIN
	...
	DR.DR_FIRST_NAME, DR.DR_LAST_NAME, AD.IS_ACTIVE,A.dosage, A.DurationAmount,
	A.DurationUnit, A.DrugComments, A.UseGeneric,
	A.DaysSupply, A.prn, A.PrnDescription, A.DateStart, A.DateEnd,
	qry.EVD_EXT_VOCAB_ID as RxNormCode, AD.MEDID ACTIVEDDID, p.pres_prescription_type
...
WHERE A.PatientId = @PatientId AND (H.ETC_DEFAULT_USE_IND IS NULL or H.ETC_DEFAULT_USE_IND = 1)  and PatientPastHxMedicationId=@PatientPastHxMedicationId
