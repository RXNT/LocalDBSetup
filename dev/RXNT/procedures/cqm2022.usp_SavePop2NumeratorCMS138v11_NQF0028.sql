...
CREATE   PROCEDURE [cqm2022].[usp_SavePop2NumeratorCMS138v11_NQF0028]
	@RequestId BIGINT 
AS
BEGIN
	...
	FROM cqm2022.DoctorCQMCalcPop2CMS138v11_NQF0028 IPP WITH(NOLOCK)
	...
	SET Numerator = 1 
	FROM [cqm2022].[DoctorCQMCalcPop2CMS138v11_NQF0028] num WITH(NOLOCK)
