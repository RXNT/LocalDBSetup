...
-- =============================================
CREATE PROCEDURE [dbo].[AMC_MEASAURE_09_MISSING_PATIENTS] 
...
BEGIN
	...
	--	AND pmc.rec_date between @DTSTART and @DTEND
	)r) q where q.numerator is null) order by pa_first, pa_last
	END
	ELSE
	BEGIN
