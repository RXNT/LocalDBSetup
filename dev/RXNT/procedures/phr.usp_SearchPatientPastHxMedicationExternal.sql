...
Last Modifed Date	:   15-Dec-2022
=======================================================================================
*/
CREATE PROCEDURE [phr].[usp_SearchPatientPastHxMedicationExternal]
    @PatientId			BIGINT
AS
BEGIN

    SELECT DISTINCT PatientPastHxMedicationExtId,
        A.DRUGID,
        ...
        A.DateStart,
        A.DateEnd,
        R1.EVD_EXT_VOCAB_ID as RxNormCode,
        AD.MEDID ACTIVEDDID,
        p.pres_prescription_type
    FROM ehr.PatientPastHxMedicationExternal A WITH(NOLOCK)
        ...
        LEFT OUTER JOIN Cust_REVDEL0 R1 WITH(NOLOCK) on A.drugid = R1.EVD_FDB_VOCAB_ID
