...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SavePop3IPPCMS138v11_NQF0028]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO cqm2023.DoctorCQMCalcPop3CMS138v11_NQF0028
	...
	LEFT JOIN [cqm2023].[DoctorCQMCalcPop3CMS138v11_NQF0028] IPP WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
