...
CREATE    PROCEDURE [cqm2023].[usp_SaveQDMCMS69v11_NQF0421_Encounter]
	@RequestId BIGINT
AS
BEGIN
	...
	LEFT JOIN cqm2023.PatientEncounterCodes pec WITH(NOLOCK) ON pec.PatientId = pv.pa_id AND pec.EncounterId = EncounterId AND pec.Code = @DefaultEncCode
