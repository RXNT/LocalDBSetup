...
-- Description:	To get the Patient LaboratoryTest
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SearchPatientLaboratoryTest_CMS68v11_NQF0419]  
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	 ...
	 BEGIN
		...
		FROM cqm2022.PatientLaboratoryTestCodes pec WITH(NOLOCK)
		...
		INNER JOIN cqm2022.SysLookupCQMValueSet vs WITH(NOLOCK) ON codes.ValueSetId = vs.ValueSetId AND vs.QDMCategoryId= 6 --LaboratoryTest
