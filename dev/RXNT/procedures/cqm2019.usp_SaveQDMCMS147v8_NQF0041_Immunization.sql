...
-- =============================================
CREATE PROCEDURE [cqm2019].[usp_SaveQDMCMS147v8_NQF0041_Immunization]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN cqm2019.SysLookupCMS147v8_NQF0041 cqm WITH(NOLOCK) ON cqm.Code = vacc.CVX_CODE
	...
	WHERE cqm.QDMCategoryId = 21 AND cqm.ValueSetId IN (185) AND cqm.CodeSystemId = 10
