...
-- Description: Search Patient Lab Order 
-- Modified By: 
-- Modified Date: 
-- =============================================
CREATE PROCEDURE [enc].[usp_GetPatientLabOrders]
(
	@PatientId INT
)
AS
...
plom.doc_group_lab_xref_id,plom.abn_file_path,plom.requisition_file_path, plom.label_file_path,plo.pa_lab_id, 
plo.lab_test_name,plo.urgency,plo.diagnosis,plo.lab_result_info_id,d.dr_prefix, d.dr_first_name, d.dr_middle_initial,
 ...
 WHERE plom.pa_id=@PatientId  AND plo.isActive=1 ORDER BY plom.order_date DESC,plo.pa_lab_id DESC
END
GO
