...
CREATE PROCEDURE [cqm2019].[usp_SavePop2NumeratorCMS155v7_NQF0024]
	@RequestId BIGINT  
AS
BEGIN
	...
	set Numerator = 1
	FROM cqm2019.[DoctorCQMCalcPop2CMS155v7_NQF0024] IPP WITH(NOLOCK)
	...
	AND cqm.QDMCategoryId = 4 AND cqm.CodeSystemId IN (4,8) AND cqm.ValueSetId = 94
