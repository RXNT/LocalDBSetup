...
CREATE PROCEDURE [cqm2019].[usp_GetDoctorQRDAIII_CMS155v7_NQF0024_POP2]  
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
AS
BEGIN
	 ...
	 BEGIN
		 ...
		 FROM  [cqm2019].[DoctorCQMCalcPop2CMS155v7_NQF0024] N WITH(NOLOCK)
		...
		INNER JOIN [cqm2019].[DoctorCQMCalcPop2CMS155v7_NQF0024] N WITH(NOLOCK) ON pat.pa_id = N.PatientId
		...
		INNER JOIN [cqm2019].[DoctorCQMCalcPop2CMS155v7_NQF0024] N WITH(NOLOCK) ON pyr.pa_id = N.PatientId
