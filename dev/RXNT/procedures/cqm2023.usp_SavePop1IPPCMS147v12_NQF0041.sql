...
CREATE    PROCEDURE [cqm2023].[usp_SavePop1IPPCMS147v12_NQF0041]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO cqm2023.DoctorCQMCalcPop1CMS147v12_NQF0041
	...
	INNER JOIN (
		...
		FROM cqm2023.PatientProcedureCodes ppc WITH(NOLOCK) 
		...
		INNER JOIN cqm2023.SysLookupCMS147v12_NQF0041 cqm WITH(NOLOCK) on cqm.code = pec.Code
	...
	LEFT OUTER JOIN [cqm2023].[DoctorCQMCalcPop1CMS147v12_NQF0041] IPP WITH(NOLOCK)  ON IPP.RequestId = @RequestId AND IPP.PatientId = pat.pa_id AND IPP.IPP = 1
