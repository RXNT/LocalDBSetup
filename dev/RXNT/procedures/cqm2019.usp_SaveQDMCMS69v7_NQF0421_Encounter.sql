...
CREATE PROCEDURE [cqm2019].[usp_SaveQDMCMS69v7_NQF0421_Encounter]
	@RequestId BIGINT
AS
BEGIN
	...
	LEFT JOIN cqm2019.PatientEncounterCodes pec WITH(NOLOCK) ON pec.PatientId = pv.pa_id AND pec.EncounterId = EncounterId AND pec.Code = @DefaultEncCode
