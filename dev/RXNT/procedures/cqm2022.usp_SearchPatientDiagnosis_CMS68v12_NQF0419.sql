...
-- Description:	To search Patient Diagnosis for Measure CMS68v12_NQF0419
-- =============================================

CREATE   PROCEDURE [cqm2022].[usp_SearchPatientDiagnosis_CMS68v12_NQF0419]  
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	 ...
	 BEGIN
		...
		FROM cqm2022.PatientDiagnosisCodes pec WITH(NOLOCK)
		...
		INNER JOIN cqm2022.SysLookupCQMValueSet vs WITH(NOLOCK) ON codes.ValueSetId = vs.ValueSetId AND vs.QDMCategoryId= 1 --Condition/Diagnosis/Problem
