...
-- =============================================
CREATE PROCEDURE [cqm2019].[usp_SavePop1IPPCMS155v7_NQF0024]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO [cqm2019].[DoctorCQMCalcPop1CMS155v7_NQF0024]
	...
	LEFT JOIN cqm2019.[DoctorCQMCalcPop1CMS155v7_NQF0024] IPP WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
