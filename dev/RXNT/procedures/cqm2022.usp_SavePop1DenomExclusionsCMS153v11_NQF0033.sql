...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SavePop1DenomExclusionsCMS153v11_NQF0033]
	@RequestId BIGINT 
AS
BEGIN
	...
	AND EXISTS (
		...
		INNER JOIN [cqm2022].[SysLookupCMS153v11_NQF0033] as cqm with(NOLOCK) on pmc.Code = cqm.Code
