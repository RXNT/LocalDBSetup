...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SaveQDMCMS136v11_NQF0108_Medication]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN cqm2022.[SysLookupCMS136v11_NQF0108] cqm WITH(NOLOCK)  ON cqm.Code = EVD_EXT_VOCAB_ID
	) Rxn ON rxn.ddid = CAST(pam.drug_id AS VARCHAR(20))
	INNER JOIN cqm2022.[SysLookupCMS136v11_NQF0108] cqm  WITH(NOLOCK) on cqm.code = rxn.RxNORMCode
