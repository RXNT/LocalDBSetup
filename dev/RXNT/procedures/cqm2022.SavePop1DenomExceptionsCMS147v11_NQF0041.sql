...
-- =============================================
CREATE   PROCEDURE [cqm2022].[SavePop1DenomExceptionsCMS147v11_NQF0041]  
	@RequestId BIGINT  
AS
BEGIN
	SET NOCOUNT ON;
	...
	FROM cqm2022.DoctorCQMCalcPop1CMS147v11_NQF0041 IPP WITH(NOLOCK)
	...
	INNER JOIN cqm2022.SysLookUpCMS147v11_NQF0041 cqm WITH(NOLOCK) on cqm.code = pdc.code
	...
	INNER JOIN cqm2022.[SysLookUpCMS147v11_NQF0041] cqm WITH(NOLOCK) on cqm.code = ppc.code
	WHERE dg.dc_id=@DoctorCompanyId AND IPP.DoctorId = @DoctorId 
	...
	INNER JOIN patients pat WITH(NOLOCK) ON pat.pa_id=IPP.PatientId
	INNER JOIN doc_groups dg WITH(NOLOCK) ON pat.dg_id=dg.dg_id
	INNER JOIN cqm2022.PatientImmunizationCodes pmc WITH(NOLOCK) ON pmc.PatientId = IPP.patientId
	INNER JOIN cqm2022.[SysLookUpCMS147v11_NQF0041] cqm WITH(NOLOCK) on cqm.code = pmc.code
	WHERE dg.dc_id=@DoctorCompanyId AND IPP.DoctorId = @DoctorId
