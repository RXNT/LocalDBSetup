...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SavePop1IPPCMS69v11_NQF0421]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO [cqm2023].[DoctorCQMCalcPop1CMS69v11_NQF0421]
	...
	LEFT JOIN cqm2023.[DoctorCQMCalcPop1CMS69v11_NQF0421] IPP  WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
