...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SaveQDMCMS68v11_NQF0419_Medications]
	@RequestId BIGINT
AS
BEGIN
	...
	LEFT JOIN cqm2022.[SysLookupCMS68v11_NQF0419] cqm WITH(NOLOCK) ON cqm.code = '428191000124101'
