...
-- =============================================
CREATE PROCEDURE [cqm2019].[usp_SaveQDMCMS153v7_NQF0033_Procedures]
	@RequestId BIGINT
AS
BEGIN
	...
	SELECT pp.pa_id, [cqm2019].[FindClosestEncounter](pp.date_performed, pp.pa_id, @DoctorId) AS EncounterId,
	...
	INNER JOIN cqm2019.[SysLookupCMS153v7_NQF0033] cqm WITH(NOLOCK) on cqm.code = pp.code
