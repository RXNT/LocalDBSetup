...
-- =============================================
CREATE PROCEDURE [cqm2018].[usp_SaveQDMCMS136v7_NQF0108_Prescription]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN [cqm2018].[SysLookupCMS136v7_NQF0108] cqm WITH(NOLOCK) ON cqm.Code = r1.EVD_EXT_VOCAB_ID
