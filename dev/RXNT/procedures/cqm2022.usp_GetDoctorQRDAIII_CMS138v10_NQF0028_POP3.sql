...
CREATE   PROCEDURE [cqm2022].[usp_GetDoctorQRDAIII_CMS138v10_NQF0028_POP3]
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
AS
BEGIN
	 ...
	 BEGIN
		 ...
		 FROM  [cqm2022].[DoctorCQMCalcPop3CMS138v10_NQF0028] N WITH(NOLOCK)
		...
		INNER JOIN [cqm2022].[DoctorCQMCalcPop3CMS138v10_NQF0028] N WITH(NOLOCK) ON pat.pa_id = N.PatientId
		...
		INNER JOIN [cqm2022].[DoctorCQMCalcPop3CMS138v10_NQF0028] N WITH(NOLOCK) ON pyr.pa_id = N.PatientId
