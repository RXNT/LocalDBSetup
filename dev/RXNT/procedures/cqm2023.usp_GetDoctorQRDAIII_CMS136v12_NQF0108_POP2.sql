...
CREATE   PROCEDURE [cqm2023].[usp_GetDoctorQRDAIII_CMS136v12_NQF0108_POP2]  
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
AS
BEGIN
	 ...
	 BEGIN
		 ...
		 FROM  [cqm2023].[DoctorCQMCalcPop2CMS136v12_NQF0108] N WITH(NOLOCK)
		...
		INNER JOIN [cqm2023].[DoctorCQMCalcPop2CMS136v12_NQF0108] N WITH(NOLOCK) ON pat.pa_id = N.PatientId
		...
		INNER JOIN [cqm2023].[DoctorCQMCalcPop2CMS136v12_NQF0108] N WITH(NOLOCK) ON pyr.pa_id = N.PatientId
