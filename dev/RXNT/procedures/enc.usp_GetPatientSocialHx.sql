...
-- Modified Date: 
-- =============================================
CREATE PROCEDURE [enc].[usp_GetPatientSocialHx]
	@PatientId BIGINT
AS

BEGIN
	SET NOCOUNT ON;
	SELECT sochx.sochxid, sochx.pat_id,sochx.emp_info,sochx.household_people_no,
	sochx.comments,sochx.dr_id,sochx.added_by_dr_id,sochx.created_on,
	sochx.last_modified_on,sochx.last_modified_by,sochx.enable,
	sochx.StrenousDays,
	...
	sochx.familyhx_other,
	sochx.medicalhx_other,
	sochx.surgeryhx_other,
	sochx.hospitalizationhx_other,
	sochx.TobaccoUse,
	sochx.MarijuanaUse,
	sochx.Vaping,
