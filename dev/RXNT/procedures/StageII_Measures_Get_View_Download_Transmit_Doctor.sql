...
-- Description: Procedure to get the measures data for View_Download_Transmit_Doctor    
-- =============================================    
CREATE PROCEDURE [dbo].[StageII_Measures_Get_View_Download_Transmit_Doctor]    
