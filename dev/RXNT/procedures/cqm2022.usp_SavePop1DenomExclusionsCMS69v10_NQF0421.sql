...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SavePop1DenomExclusionsCMS69v10_NQF0421]
	@RequestId BIGINT  
AS
BEGIN
	...
	INNER JOIN (
		...
		INNER JOIN cqm2022.[SysLookUpCMS69v10_NQF0421] cqm WITH(NOLOCK) on cqm.code = ppc.code
		...
		INNER JOIN cqm2022.[SysLookUpCMS69v10_NQF0421] cqm  WITH(NOLOCK) on cqm.code = pdc.code
