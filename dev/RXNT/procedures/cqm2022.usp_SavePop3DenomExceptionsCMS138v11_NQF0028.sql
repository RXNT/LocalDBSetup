...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SavePop3DenomExceptionsCMS138v11_NQF0028]
	@RequestId BIGINT 
AS
BEGIN
	...
	INNER JOIN [cqm2022].[SysLookupCMS138v11_NQF0028] cqm WITH(NOLOCK) on cqm.Code = pdc.Code
