...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SavePop3DenomExclusionsCMS155v10_NQF0024]
	@RequestId BIGINT  
AS
BEGIN
	...
	FROM [cqm2022].[DoctorCQMCalcPop3CMS155v10_NQF0024] IPP WITH(NOLOCK)
	...
	INNER JOIN [cqm2022].[SysLookUpCMS155v10_NQF0024] cqm WITH(NOLOCK) on cqm.code = pdc.code
