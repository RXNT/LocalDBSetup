...
-- Description:	To populate QDM tables for the measureCMS138v10_NQF0028
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SaveQDMCMS138v10_NQF0028_Diagnosis]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN [cqm2022].[SysLookUpCMS138v10_NQF0028] cqm WITH(NOLOCK) ON pad.snomed_code = cqm.code 
