...
CREATE PROCEDURE [cqm2018].[usp_SavePop2NumeratorCMS155v6_NQF0024]
	@RequestId BIGINT  
AS
BEGIN
	...
	set Numerator = 1
	FROM cqm2018.[DoctorCQMCalcPop2CMS155v6_NQF0024] IPP WITH(NOLOCK)
	...
	AND cqm.QDMCategoryId = 4 AND cqm.CodeSystemId IN (3,5) AND cqm.ValueSetId = 94
