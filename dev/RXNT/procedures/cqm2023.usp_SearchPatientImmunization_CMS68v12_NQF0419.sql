...
CREATE    PROCEDURE [cqm2023].[usp_SearchPatientImmunization_CMS68v12_NQF0419]    
 @PatientId BIGINT,   
 @DoctorId BIGINT,   
 @StartDate Date,  
 @EndDate Date   
...
BEGIN  
	...
	FROM cqm2023.PatientImmunizationCodes pec WITH(NOLOCK)  
	...
	INNER JOIN cqm2023.SysLookupCQMValueSet vs ON codes.ValueSetId = vs.ValueSetId AND vs.QDMCategoryId= 8 --Immunization  
