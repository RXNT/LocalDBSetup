...
CREATE    PROCEDURE [cqm2023].[usp_SearchPatientMedicationAllergies_CMS68v12_NQF0419]  
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	 ...
	 BEGIN
		...
		INNER JOIN cqm2023.SysLookupCMS68v12_NQF0419 codes ON a.rxnorm_code = codes.Code 
		INNER JOIN cqm2023.SysLookupCodeSystem cs ON codes.CodeSystemId = cs.CodeSystemId
		INNER JOIN cqm2023.SysLookupCQMValueSet vs ON codes.ValueSetId = vs.ValueSetId AND vs.QDMCategoryId= 8 --Medication Allergy
