...
CREATE    PROCEDURE [cqm2023].[usp_SavePop2NumeratorCMS136v12_NQF0108]
	@RequestId BIGINT  
AS
BEGIN
	...
	(
		...
		LEFT JOIN cqm2023.DoctorCQMCalcPop2CMS136v12_NQF0108 IPP  WITH(NOLOCK) on IPP.PatientId = pmc.PatientId AND IPP.RequestId = @RequestId
	...
	SET Numerator = 1
	FROM cqm2023.DoctorCQMCalcPOP2CMS136v12_NQF0108 IPP WITH(NOLOCK)
	...
	INNER JOIN cqm2023.PatientEncounterCodes pec1  WITH(NOLOCK) on pec1.PatientId = IPP.PatientId
