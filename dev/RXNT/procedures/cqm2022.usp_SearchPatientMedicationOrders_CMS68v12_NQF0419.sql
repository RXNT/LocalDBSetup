...
CREATE   PROCEDURE [cqm2022].[usp_SearchPatientMedicationOrders_CMS68v12_NQF0419]
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	 ...
	 BEGIN
		...
		LEFT OUTER  JOIN cqm2022.SysLookupCMS68v12_NQF0419 codes_rson ON pp_rson.code = codes_rson.Code
