...
-- Description:	To get the Patient MedicationProcedure
-- =============================================

CREATE    PROCEDURE [cqm2023].[usp_SearchPatientMedicationProcedure_CMS68v12_NQF0419]  
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	 ...
	 BEGIN
		...
		FROM cqm2023.PatientMedicationProcedureCodes pec WITH(NOLOCK)
		...
		INNER JOIN cqm2023.SysLookupCQMValueSet vs WITH(NOLOCK) ON codes.ValueSetId = vs.ValueSetId AND vs.QDMCategoryId= 11 --MedicationProcedure
