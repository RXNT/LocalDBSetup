...
CREATE   PROCEDURE [cqm2022].[usp_SavePop1IPPCMS147v11_NQF0041]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO cqm2022.DoctorCQMCalcPop1CMS147v11_NQF0041
	...
	INNER JOIN (
		...
		INNER JOIN cqm2022.SysLookupCMS147v11_NQF0041 cqm WITH(NOLOCK) on cqm.code = pec.Code
	...
	LEFT OUTER JOIN [cqm2022].[DoctorCQMCalcPop1CMS147v11_NQF0041] IPP WITH(NOLOCK)  ON IPP.RequestId = @RequestId AND IPP.PatientId = pat.pa_id AND IPP.IPP = 1
