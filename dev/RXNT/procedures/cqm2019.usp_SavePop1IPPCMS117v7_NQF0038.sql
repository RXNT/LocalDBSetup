...
-- =============================================
CREATE PROCEDURE [cqm2019].[usp_SavePop1IPPCMS117v7_NQF0038]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO [cqm2019].[DoctorCQMCalcPop1CMS117v7_NQF0038]
	...
	LEFT JOIN [cqm2019].[DoctorCQMCalcPop1CMS117v7_NQF0038] IPP WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
