...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SaveQDMCMS117v10_NQF0038_LabTest]
	@RequestId BIGINT
AS
BEGIN
	...
	[cqm2022].[FindClosestEncounter](lrf.obs_date, lm.pat_id, @DoctorId) AS EncounterId,
	...
	INNER JOIN [cqm2022].[SysLookupCMS117v10_NQF0038] cqm WITH(NOLOCK) ON lrf.obs_bat_ident = cqm.code 
