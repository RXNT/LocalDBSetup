...
-- Modified Date: 
-- =============================================
CREATE PROCEDURE [ehr].[usp_SearchPatientDiagnosis]
	@PatientId BIGINT
AS
...
BEGIN
	...
	pad.date_added,pad.enabled, pad.onset, pad.severity, pad.record_source, pad.status_date, pad.diagnosis_sequence,pad.last_modified_date,pad.visibility_hidden_to_patient
