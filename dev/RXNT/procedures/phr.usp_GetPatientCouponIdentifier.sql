...
-- Modified Date:   
-- =============================================  
CREATE PROCEDURE [phr].[usp_GetPatientCouponIdentifier]--[phr].[usp_SetPatientCouponIdentifier] 40905294,1,'9b691f3a-4eb1-451f-861f-7ed106ad32d8'  
 @PatientId BIGINT,  
...
BEGIN  
 BEGIN TRAN T1;    
  ...
  SELECT @coupon_identifier_id coupon_identifier_id,@client_provided_id client_provided_id  
 COMMIT TRAN T1;    
