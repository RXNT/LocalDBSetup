...
CREATE PROCEDURE [cqm2018].[usp_SavePop2NumeratorCMS136v7_NQF0108]
	@RequestId BIGINT  
AS
BEGIN
	...
	(
		...
		LEFT JOIN cqm2018.DoctorCQMCalcPop2CMS136v7_NQF0108 IPP  WITH(NOLOCK) on IPP.PatientId = pmc.PatientId AND IPP.RequestId = @RequestId
	...
	SET Numerator = 1
	FROM cqm2018.DoctorCQMCalcPOP2CMS136v7_NQF0108 IPP WITH(NOLOCK)
	...
	INNER JOIN cqm2018.PatientEncounterCodes pec1  WITH(NOLOCK) on pec1.PatientId = IPP.PatientId
