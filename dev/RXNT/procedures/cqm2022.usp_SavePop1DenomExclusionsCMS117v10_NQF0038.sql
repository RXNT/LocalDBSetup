...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SavePop1DenomExclusionsCMS117v10_NQF0038]
	@RequestId BIGINT  
AS
BEGIN
	...
	FROM [cqm2022].[DoctorCQMCalcPop1CMS117v10_NQF0038] IPP
	...
	INNER JOIN [cqm2022].[SysLookupCMS117v10_NQF0038] cqm on cqm.code = pic.code
