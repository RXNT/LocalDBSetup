...
CREATE   PROCEDURE [cqm2022].[usp_SearchPatientMedicationProcedure_CMS68v12_NQF0419]  
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	 ...
	 BEGIN
		...
		FROM cqm2022.PatientMedicationProcedureCodes pec WITH(NOLOCK)
		...
		INNER JOIN cqm2022.SysLookupCQMValueSet vs WITH(NOLOCK) ON codes.ValueSetId = vs.ValueSetId AND vs.QDMCategoryId= 11 --MedicationProcedure
