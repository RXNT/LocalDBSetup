...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SavePop3DenomExceptionsCMS138v11_NQF0028]
	@RequestId BIGINT 
AS
BEGIN
	...
	INNER JOIN [cqm2023].[SysLookupCMS138v11_NQF0028] cqm WITH(NOLOCK) on cqm.Code = pdc.Code
	...
	AND cqm.QDMCategoryId = 1 AND cqm.CodeSystemId IN(4,20) AND cqm.ValueSetId = 158
