...
CREATE   PROCEDURE [cqm2022].[usp_SearchPatientMedicationAllergies_CMS68v12_NQF0419]  
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	 ...
	 BEGIN
		...
		INNER JOIN cqm2022.SysLookupCMS68v12_NQF0419 codes ON a.rxnorm_code = codes.Code 
