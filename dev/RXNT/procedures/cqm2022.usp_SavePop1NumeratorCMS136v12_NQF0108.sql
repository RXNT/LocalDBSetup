...
CREATE   PROCEDURE [cqm2022].[usp_SavePop1NumeratorCMS136v12_NQF0108]
	@RequestId BIGINT  
AS
BEGIN
	...
	UPDATE TOP(@MaxRowCount) cqm2022.DoctorCQMCalcPOP1CMS136v12_NQF0108
	SET Numerator = 1
	FROM cqm2022.DoctorCQMCalcPOP1CMS136v12_NQF0108 IPP WITH(NOLOCK)
	INNER JOIN patients pat WITH(NOLOCK) ON pat.pa_id=IPP.PatientId
	INNER JOIN doc_groups dg WITH(NOLOCK) ON pat.dg_id=dg.dg_id
