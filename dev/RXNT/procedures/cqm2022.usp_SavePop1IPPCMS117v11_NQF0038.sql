...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SavePop1IPPCMS117v11_NQF0038]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO [cqm2022].[DoctorCQMCalcPop1CMS117v11_NQF0038]
	...
	LEFT JOIN [cqm2022].[DoctorCQMCalcPop1CMS117v11_NQF0038] IPP WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
