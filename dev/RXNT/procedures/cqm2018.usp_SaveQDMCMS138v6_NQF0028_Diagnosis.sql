...
-- Description:	To populate QDM tables for the measureCMS138v6_NQF0028
-- =============================================
CREATE PROCEDURE [cqm2018].[usp_SaveQDMCMS138v6_NQF0028_Diagnosis]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN [cqm2018].[SysLookUpCMS138v6_NQF0028] cqm WITH(NOLOCK) ON pad.snomed_code = cqm.code 
