...
CREATE   PROCEDURE [ehr].[SaveSelectedChangeRxRequestedDrug]
	@ChgReqId BIGINT, 
...
BEGIN
	...
	BEGIN
		...
		SET drug_name = @DrugName, ddid =  @DrugId , dosage = ISNULL(@Dosage,''),  use_generic = @IsUseGeneric , numb_refills =  @NoOfRefills , comments = ISNULL(@Comments,''), days_supply =  @DaysSupply  ,
