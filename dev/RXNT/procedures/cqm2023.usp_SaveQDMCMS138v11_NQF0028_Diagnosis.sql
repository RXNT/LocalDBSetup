...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SaveQDMCMS138v11_NQF0028_Diagnosis]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN [cqm2023].[SysLookUpCMS138v11_NQF0028] cqm WITH(NOLOCK) ON pad.snomed_code = cqm.code 
