...
CREATE   PROCEDURE [cqm2022].[usp_SavePop1NumeratorCMS69v11_NQF0421]
	@RequestId BIGINT  
AS
BEGIN
	...
	SET Numerator = 1
	FROM cqm2022.[DoctorCQMCalcPop1CMS69v11_NQF0421] IPP WITH(NOLOCK)
	...
	AND pec.PerformedFromDate BETWEEN @StartDate AND @EndDate
		...
		INNER JOIN cqm2022.[SysLookUpCMS69v11_NQF0421] cqm WITH(NOLOCK) on cqm.code = pmc.code
		...
		INNER JOIN cqm2022.[SysLookUpCMS69v11_NQF0421] cqm WITH(NOLOCK) on cqm.code = pic.code
		LEFT OUTER JOIN @temp3 t3 ON pat.PatientId=t3.PatientId
	...
	INNER JOIN cqm2022.[DoctorCQMCalcPop1CMS69v11_NQF0421] num WITH(NOLOCK) ON pat.pa_id=num.PatientId
	INNER JOIN doc_groups dg WITH(NOLOCK) ON pat.dg_id=dg.dg_id
	...
	SET Numerator = 1 
	FROM cqm2022.[DoctorCQMCalcPop1CMS69v11_NQF0421] num 
	...
	FROM cqm2022.[DoctorCQMCalcPop1CMS69v11_NQF0421] num WITH(NOLOCK) 
