...
-- Description:	To get the Patient PhysicalExam
-- =============================================

CREATE   PROCEDURE [cqm2022].[usp_SearchPatientPhysicalExam_CMS68v11_NQF0419]  
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	 ...
	 BEGIN
		...
		FROM cqm2022.PatientPhysicalExamCodes pec WITH(NOLOCK)
		...
		INNER JOIN cqm2022.SysLookupCQMValueSet vs WITH(NOLOCK) ON codes.ValueSetId = vs.ValueSetId AND vs.QDMCategoryId= 13 --PhysicalExam
