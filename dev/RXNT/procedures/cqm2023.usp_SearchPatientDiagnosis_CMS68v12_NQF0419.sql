...
CREATE    PROCEDURE [cqm2023].[usp_SearchPatientDiagnosis_CMS68v12_NQF0419]  
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	 ...
	 BEGIN
		...
		FROM cqm2023.PatientDiagnosisCodes pec WITH(NOLOCK)
		...
		INNER JOIN cqm2023.SysLookupCQMValueSet vs WITH(NOLOCK) ON codes.ValueSetId = vs.ValueSetId AND vs.QDMCategoryId= 1 --Condition/Diagnosis/Problem
