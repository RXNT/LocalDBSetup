...
-- =============================================
CREATE PROCEDURE [dbo].[FetchPatientMedicationDischarges]
	@pa_id int
AS
BEGIN
	...
	PD.NUMB_REFILLS, PD.DURATION_AMOUNT, PD.DURATION_UNIT, PD.PRN, PD.PRN_DESCRIPTION, PD.ICD9,PD.CANCEL_STATUS,PD.CANCEL_STATUS_TEXT,
	...
	INNER JOIN prescription_discharge_requests PDR WITH(NOLOCK)  ON P.PRES_ID = PDR.PRES_ID
