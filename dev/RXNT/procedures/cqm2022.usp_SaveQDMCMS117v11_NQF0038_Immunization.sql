...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SaveQDMCMS117v11_NQF0038_Immunization]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN [cqm2022].[SysLookupCMS117v11_NQF0038] cqm WITH(NOLOCK) ON cqm.Code = vacc.CVX_CODE
