...
-- =============================================
CREATE PROCEDURE [cqm2019].[usp_SaveQDMCMS153v7_NQF0033_Prescription]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN cqm2019.[SysLookupCMS153v7_NQF0033] cqm WITH(NOLOCK) on cqm.code = vwRx.RxNormCode
	...
	AND cqm.QDMCategoryId = 5 AND cqm.CodeSystemId = 7 AND cqm.ValueSetId IN (73,81)
