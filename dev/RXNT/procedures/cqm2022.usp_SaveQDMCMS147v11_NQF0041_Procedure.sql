...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SaveQDMCMS147v11_NQF0041_Procedure]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN [cqm2022].SysLookupCMS147v11_NQF0041 cqm WITH(NOLOCK) on cqm.code = pp.code
	...
	WHERE cqm.QDMCategoryId IN (22,10) AND cqm.ValueSetId IN (55,56,64,184) AND cqm.CodeSystemId IN (2,3,4,17,18,20,27,28,29,30,31)
