...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SaveQDMCMS136v11_NQF0108_Prescription]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN [cqm2022].[SysLookupCMS136v11_NQF0108] cqm WITH(NOLOCK) ON cqm.Code = r1.EVD_EXT_VOCAB_ID
