...
-- =============================================
CREATE PROCEDURE [cqm2019].[usp_SavePop1IPPCMS69v7_NQF0421]
	@RequestId BIGINT  
AS
BEGIN
	...
	INSERT INTO [cqm2019].[DoctorCQMCalcPop1CMS69v7_NQF0421]
	...
	LEFT JOIN cqm2019.[DoctorCQMCalcPop1CMS69v7_NQF0421] IPP  WITH(NOLOCK) ON IPP.PatientId = pat.pa_id AND IPP.RequestId = @RequestId
