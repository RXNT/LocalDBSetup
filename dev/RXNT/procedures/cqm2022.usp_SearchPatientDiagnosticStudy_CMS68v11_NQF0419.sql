...
-- Description:	To search Patient Diagnostics study for Measure CMS68v11_NQF0419
-- =============================================

CREATE   PROCEDURE [cqm2022].[usp_SearchPatientDiagnosticStudy_CMS68v11_NQF0419]  
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
