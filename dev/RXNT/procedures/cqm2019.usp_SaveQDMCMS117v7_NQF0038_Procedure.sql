...
-- =============================================
-- Author:		Niyaz
-- Create date: 9th-NOV-2019
-- Description:	To populate QDM tables for the measure CMS117v7_NQF0038
-- =============================================
CREATE PROCEDURE [cqm2019].[usp_SaveQDMCMS117v7_NQF0038_Procedure]
	@RequestId BIGINT
AS
BEGIN
	...
	INNER JOIN [cqm2019].[SysLookupCMS117v7_NQF0038] cqm WITH(NOLOCK) on cqm.code = pp.code
