...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SaveQDMCMS153v11_NQF0033_LabTest]
	@RequestId BIGINT
AS
BEGIN
	...
	INSERT INTO cqm2023.PatientLaboratoryTestCodes	
	...
	LEFT JOIN cqm2023.PatientLaboratoryTestCodes pltc WITH(NOLOCK) on lrf.lab_result_info_id = pltc.LaboratoryTestId AND pltc.EncounterId = EncounterId 
