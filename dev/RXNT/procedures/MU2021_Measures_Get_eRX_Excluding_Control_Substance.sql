...
-- =============================================    
CREATE PROCEDURE [dbo].[MU2021_Measures_Get_eRX_Excluding_Control_Substance]    
	@dr_id INT,
	@dg_id INT=NULL,  
...
BEGIN      
	...
	INNER JOIN dbo.MU2021Measures    MUM  WITH(NOLOCK) ON MUM.MeasureCode  = VMD.MeasureCode    
