...
-- Description:	To search Patient Communication for Measure CMS68v12_NQF0419
-- =============================================

CREATE    PROCEDURE [cqm2023].[usp_SearchPatientCommunication_CMS68v12_NQF0419]  
	@PatientId BIGINT,	
	@DoctorId BIGINT,	
	@StartDate Date,
	@EndDate Date	
...
BEGIN
	 ...
	 BEGIN
		...
		FROM cqm2023.PatientCommunicationCodes pec WITH(NOLOCK)
		...
		INNER JOIN cqm2023.SysLookupCQMValueSet vs ON codes.ValueSetId = vs.ValueSetId AND vs.QDMCategoryId= 10 --Communication
