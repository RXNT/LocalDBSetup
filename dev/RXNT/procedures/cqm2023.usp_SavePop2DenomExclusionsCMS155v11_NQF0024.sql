...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SavePop2DenomExclusionsCMS155v11_NQF0024]
	@RequestId BIGINT  
AS
BEGIN
	...
	FROM [cqm2023].[DoctorCQMCalcPop2CMS155v11_NQF0024] IPP WITH(NOLOCK)
	...
	INNER JOIN [cqm2023].[SysLookUpCMS155v11_NQF0024] cqm WITH(NOLOCK) on cqm.code = pdc.code
