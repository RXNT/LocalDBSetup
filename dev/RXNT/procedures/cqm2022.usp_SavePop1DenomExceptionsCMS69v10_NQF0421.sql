...
-- =============================================
CREATE   PROCEDURE [cqm2022].[usp_SavePop1DenomExceptionsCMS69v10_NQF0421]
	@RequestId BIGINT  
AS
BEGIN
	...
	INNER JOIN cqm2022.PatientEncounterCodes enc  WITH(NOLOCK) ON enc.EncounterId=ppc.EncounterId 
