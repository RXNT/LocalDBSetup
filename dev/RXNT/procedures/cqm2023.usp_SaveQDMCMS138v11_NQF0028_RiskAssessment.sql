...
-- =============================================
CREATE    PROCEDURE [cqm2023].[usp_SaveQDMCMS138v11_NQF0028_RiskAssessment]
	@RequestId BIGINT
AS
BEGIN
	...
	INSERT INTO [cqm2023].[PatientRiskCategoryOrAssessmentCodes]
	...
	LEFT JOIN cqm2023.PatientRiskCategoryOrAssessmentCodes prc WITH(NOLOCK) ON prc.PatientID = pec.PatientId AND prc.RiskCategoryOrAssessmentId = pfd.pa_flag_id AND prc.DoctorId = pec.DoctorId
